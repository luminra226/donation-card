...
// ======================================================
//
// Keeps the amount large while making sure very large
// numbers don't reach the player avatars.
//

function getAmountFontSize(formattedAmount) {
...
async function createDonationCard({
	...
	const amountFontSize =
		getAmountFontSize(formattedAmount);
